...
public class Main {
	...
	public static void main(String[] args) {
		...
		String targetURL = "";
		try {
			targetURL = Core.getManifest("https://www.youtube.com/watch?v=HSyaF9KOzdk");
